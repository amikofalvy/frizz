...
import {
  awaitRegistrySuccessor, canReexecInPlace, GLOBAL_INSTALL_ENV, handoffToRegistrySuccessor, isGlobalInstall, keepUpdateHint,
  npmRegistryReleaseAdapter, planRegistryUpdate, PRODUCTION_PRINT_LAUNCHER_FLAG, PRODUCTION_REEXEC_FLAG, readLauncherStatus, reexecArgv,
