...
export class RestartSupervisorProxy {
  ...
  private status(): { state: RestartControlState; message?: string; artifactDigest?: string; preparing?: boolean; updateRestart: boolean; updateAvailable?: boolean; version?: string; updateVersion?: string; dev?: boolean } {
